...
The library significally [reduces boilerplate code](DataTables.Queryable/wiki/BoilerplateReduce) and helps to avoid writing same logic of parsing requests for different model types.
